-- Continue adding administrative divisions - Latin America batch with unique slugs
...
SELECT d, CONCAT('br-', LOWER(REPLACE(REPLACE(REPLACE(d,' ', '-'),'ã','a'),'ô','o'))), c.id
...
-- Argentina - Add all provinces with unique slugs
WITH c AS (SELECT id FROM snapshot_countries WHERE slug = 'argentina' LIMIT 1)
INSERT INTO snapshot_administrative_divisions (name, slug, country_id)
SELECT d, CONCAT('ar-', LOWER(REPLACE(REPLACE(d,' ', '-'),'í','i'))), c.id
...
INSERT INTO snapshot_administrative_divisions (name, slug, country_id)
SELECT d, CONCAT('mx-', LOWER(REPLACE(REPLACE(REPLACE(d,' ', '-'),'ó','o'),'á','a'))), c.id
...
INSERT INTO snapshot_administrative_divisions (name, slug, country_id)
SELECT d, CONCAT('cl-', LOWER(REPLACE(REPLACE(d,' ', '-'),'''','-'))), c.id
...
INSERT INTO snapshot_administrative_divisions (name, slug, country_id)
SELECT d, CONCAT('ve-', LOWER(REPLACE(REPLACE(REPLACE(d,' ', '-'),'á','a'),'í','i'))), c.id
...
INSERT INTO snapshot_administrative_divisions (name, slug, country_id)
SELECT d, CONCAT('gt-', LOWER(REPLACE(REPLACE(d,' ', '-'),'é','e'))), c.id
...
INSERT INTO snapshot_administrative_divisions (name, slug, country_id)
SELECT d, CONCAT('uy-', LOWER(REPLACE(REPLACE(d,' ', '-'),'í','i'))), c.id
...
INSERT INTO snapshot_administrative_divisions (name, slug, country_id)
SELECT d, CONCAT('bo-', LOWER(REPLACE(REPLACE(d,' ', '-'),'í','i'))), c.id
...
INSERT INTO snapshot_administrative_divisions (name, slug, country_id)
SELECT d, CONCAT('py-', LOWER(REPLACE(REPLACE(d,' ', '-'),'á','a'))), c.id
...
INSERT INTO snapshot_administrative_divisions (name, slug, country_id)
SELECT d, CONCAT('cr-', LOWER(REPLACE(REPLACE(d,' ', '-'),'é','e'))), c.id
...
INSERT INTO snapshot_administrative_divisions (name, slug, country_id)
SELECT d, CONCAT('pa-', LOWER(REPLACE(REPLACE(REPLACE(d,' ', '-'),'í','i'),'á','a'))), c.id
...
INSERT INTO snapshot_administrative_divisions (name, slug, country_id)
SELECT d, CONCAT('ni-', LOWER(REPLACE(REPLACE(REPLACE(d,' ', '-'),'í','i'),'ó','o'))), c.id
...
INSERT INTO snapshot_administrative_divisions (name, slug, country_id)
SELECT d, CONCAT('hn-', LOWER(REPLACE(REPLACE(REPLACE(d,' ', '-'),'á','a'),'é','e'))), c.id
...
INSERT INTO snapshot_administrative_divisions (name, slug, country_id)
SELECT d, CONCAT('sv-', LOWER(REPLACE(REPLACE(REPLACE(d,' ', '-'),'á','a'),'ó','o'))), c.id
...
INSERT INTO snapshot_administrative_divisions (name, slug, country_id)
SELECT d, CONCAT('cu-', LOWER(REPLACE(REPLACE(REPLACE(d,' ', '-'),'í','i'),'ó','o'))), c.id
...
INSERT INTO snapshot_administrative_divisions (name, slug, country_id)
SELECT d, CONCAT('do-', LOWER(REPLACE(REPLACE(REPLACE(d,' ', '-'),'í','i'),'é','e'))), c.id
