...
UNION ALL
SELECT 'Nassau', 'nassau', id FROM snapshot_countries WHERE slug = 'cook-islands'
UNION ALL
...
-- Fiji
INSERT INTO snapshot_administrative_divisions (name, slug, country_id)
SELECT 'Central', 'central', id FROM snapshot_countries WHERE slug = 'fiji'
UNION ALL
SELECT 'Eastern', 'eastern', id FROM snapshot_countries WHERE slug = 'fiji'
UNION ALL
SELECT 'Northern', 'northern', id FROM snapshot_countries WHERE slug = 'fiji'
UNION ALL
SELECT 'Western', 'western', id FROM snapshot_countries WHERE slug = 'fiji'
UNION ALL
...
UNION ALL
SELECT 'Eastern', 'eastern', id FROM snapshot_countries WHERE slug = 'hong-kong'
UNION ALL
SELECT 'Southern', 'southern', id FROM snapshot_countries WHERE slug = 'hong-kong'
UNION ALL
...
UNION ALL
SELECT 'North', 'north', id FROM snapshot_countries WHERE slug = 'hong-kong'
UNION ALL
...
UNION ALL
SELECT 'Islands', 'islands', id FROM snapshot_countries WHERE slug = 'hong-kong'
UNION ALL
