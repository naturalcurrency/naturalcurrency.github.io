-- Seed remaining Asia/Emerging detailed divisions, then add country-specific fallbacks
...
-- Finally, ensure no country is left without at least one division using country-specific slugs
INSERT INTO snapshot_administrative_divisions (country_id, name, slug)
SELECT c.id, 'National', CONCAT(c.slug, '-national')
FROM snapshot_countries c
